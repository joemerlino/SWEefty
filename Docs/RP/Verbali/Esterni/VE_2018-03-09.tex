...
\restoregeometry
	...
	\item { 01/VE\_2018-01-31 É stato deciso di utilizzare la libreria Javascript chiamata D3.js per rappresentare graficamente i componenti nella mappa topologia del plugin. }
	\item { Si è discusso inoltre di quale versione di Kibana sia opportuno installare nei server ufficiali di test e produzione, in quanto il team ha trovato difficoltà a sviluppare con la versione development di Kibana 6.2.2(stabile) preferendo utilizzare la versione 6.2.3. Dopo un breve confronto 02/VE\_2018-01-31 si è deciso di installare nel server la versione stabile di Kibana, effettuando dunque un rollback di quanto fatto finora in modo da renderlo compatibile con la versione precedente.}
