...
\subsection{Fornitura}
	...
	\subsubsection{Scopo}
		...
		Lo scopo di questo processo è di trattare i termini e le norme, dalle più triviali alle più importanti, che tutti i componenti del gruppo SWEefty sono tenuti a rispettare per diventare fornitori dell'azienda IKS s.r.l e dei committenti Prof. Tullio Vardanega e Prof. Riccardo Cardin.
	...
	Intendiamo mantenere un costante rapporto con il proponente in modo tale da rivecere un feedback costante sul lavoro svolto.
...
\subsection{Sviluppo}
	...
	\subsubsection{Attività}
		...
		\paragraph{Progettazione}
			...
			Il responsabile di questa attività è il Progettista che deve redarre la \textit{Specifica Tecnica} e la \textit{Definizione di Prodotto} in funzione dei requisiti delineati nell'\textit{Analisi dei Requisiti} in modo da permettere di definire le linee guida da seguire durante l'attività di codifica.
			...
			Questo documento deve descrivere la progettazione in dettaglio del sistema, utilizzando i seguenti strumenti:
				...
				I diagrammi UML sono realizzati tramite il programma StarUML descritto nella sezione \ref{sec:StarUML}.
					...
					Ogni classe progettata deve essere descritta con una spiegazione sullo scopo della classe e deve specificare quale funzionalità essa modella. 
