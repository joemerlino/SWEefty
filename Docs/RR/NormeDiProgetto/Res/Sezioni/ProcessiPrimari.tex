...
\subsection{Fornitura}
	...
	In questa sezione vengono trattate le norme, dalle più triviali alle più importanti, inerenti alla progettazione, lo sviluppo e la consegna del prodotto "\textbf{OpenAPM}".
...
\subsection{Sviluppo}
	...
	\subsubsection{Attività}
		\paragraph{Analisi dei requisiti}
			...
			%\textbf{U {codice_padre}.{codice_figlio}  }
			...
			%\textbf{R {importanza}{tipo}{numero_vincolo} }
