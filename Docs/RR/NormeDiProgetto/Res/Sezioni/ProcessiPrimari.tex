...
\subsection{Sviluppo}
	...
	Al fine di implementare correttamente questo processo è necessario soddisfare i seguenti punti:
	\begin{itemize}
		\item Realizzare un prodotto software conforme alle richieste del proponente
		\item Realizzare un prodotto software che superi i test di verifica
		\item Realizzare un prodotto software che superi i test di validazione
	...
	\subsubsection{Attività}
		\paragraph{Analisi dei requisiti}
		    ...
		    In questo modo è possibile definire ed effettuare dei test di superamento del software. 
			\subparagraph{Descrizione}
			Nel documento inerente a quest'analisi sono specificati i requisiti analizzati.
			Il tracciamento dei requisiti avviene tramite il software $SWEgo_G$.
