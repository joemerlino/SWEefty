...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.1.1}{UC1.1.1}: Visualizzazione server}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.1.2}{UC1.1.2}: Visualizzazione database}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.1.3}{UC1.1.3}: Visualizzazione numero componenti di server cluster}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.2.1}{UC1.2.1}: Visualizzazione delle richieste HTTP}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.2.2}{UC1.2.2}: Visualizzazione delle richieste ai database}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.2.3}{UC1.2.3}: Colorazione degli archi corrispondenti a tempi di risposta critici}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.3.2.1}{UC1.3.2.1}: Visualizzazione del nome identificativo per i server}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC1.3.2.2}{UC1.3.2.2}: Visualizzazione del nome identificativo per i database}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC2.1}{UC2.1}: Visualizzazione numerazione traces}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC2.2}{UC2.2}: Visualizzazione identificativo traces tramite richiesta HTTP}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC2.3}{UC2.3}: Visualizzazione tempo di esecuzione traces}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC2.4}{UC2.4}: Visualizzazione momento di esecuzione traces}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC2.5}{UC2.5}: Ordinamento di default lista delle traces}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC2.6}{UC2.6}: Visualizzazione codice di stato HTTP di ogni trace}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC2.6.1}{UC2.6.1}: Visualizzazione dettaglio errore}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3}{UC3}: Queries singola trace}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3.1}{UC3.1}: Ordinamento di defaul delle queries}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3.2}{UC3.2}: Visualizzazione numerazione di ogni query}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3.3}{UC3.3}: Visualizzazione testo di ogni query}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3.4}{UC3.4}: Visualizzazione identificativo database interrogato}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3.5}{UC3.5}: Visualizzazione momento di esecuzione di ogni query}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC3.6}{UC3.6}: Visualizzazione tempo di esecuzione di ogni query}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\end{itemize}
\subsection{Caso d'uso \hyperref{UC6}{UC6}: Interazione con la mappa topologica}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC6.1}{UC6.1}: Ridimensionamento della mappa topologica}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC6.1.1}{UC6.1.1}: Ingrandimento della mappa topologica}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC6.1.2}{UC6.1.2}: Restringimento della mappa}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC6.2}{UC6.2}: Riposizionamento componente}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC6.3}{UC6.3}: Riposizionamento automatico componenti}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC6.4}{UC6.4}: Visualizzazione mappa a schermo intero}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC7.1}{UC7.1}: Riordinamento dello stack trace per momento di inizio dell'esecuzione}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC7.1.1}{UC7.1.1}: Riordinamento dello stack trace per momento di inizio dell'esecuzione decrescente}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC7.1.2}{UC7.1.2}: Riordinamento dello stack trace per momento di inizio dell'esecuzione crescente.}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC7.2}{UC7.2}: Riordinamento dello stack trace per tempo di esecuzione.}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC7.2.1}{UC7.2.1}: Riordinamento dello stack trace per tempo di esecuzione decrescente}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC7.2.2}{UC7.2.2}: Riordinamento dello stack trace per tempo di esecuzione crescente.}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC8.1}{UC8.1}: Visualizzazione nome metodi}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC8.2}{UC8.2}: Visualizzazione self execution time}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC8.3}{UC8.3}: Visualizzazione total execution time}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC8.4}{UC8.4}: Indentazione sottochiamate}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC8.5}{UC8.5}: Visualizzazione di default call tree}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC8.6}{UC8.6}: Visualizzazione queries di ogni metodo}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10}{UC10}: Riordinamento delle queries di una singola trace}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.1}{UC10.1}: Riordinamento delle queries per momento di inizio dell'esecuzione}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.1.1}{UC10.1.1}: Riordinamento delle queries per momento di inizio dell'esecuzione crescente.}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.1.2}{UC10.1.2}: Riordinamento delle queries per momento di inizio dell'esecuzione decrescente}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.2}{UC10.2}: Riordinamento delle queries per tempo di esecuzione.}
\begin{figure} [H]
\centering
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.2.1}{UC10.2.1}: Riordinamento delle queries per tempo di esecuzione crescente.}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC10.2.2}{UC10.2.2}: Riordinamento delle queries per tempo di esecuzione decrescente}
\begin{itemize}
\item \textbf{Attori}: Utente
...
\end{itemize}
\subsection{Caso d'uso \hyperref{UC11}{UC11}: Lettura dei dati da Kibana}
\begin{itemize}
