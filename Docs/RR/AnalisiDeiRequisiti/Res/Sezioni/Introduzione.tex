\section{Introduzione}
	...
	\begin{itemize}
		...
		\item \textbf{Capitolato d'appalto C7:} OpenAPM: cruscotto di Application Performance Management \\ \url{http://www.math.unipd.it/~tullio/IS-1/2017/Progetto/C7.pdf} (ultima consultazione effettuata in data 2017-12-20);
	...
	\begin{itemize}
		...
		\item \textbf{APM con Elastic Stack:} \url{https://www.elastic.co/guide/en/apm/get-started/current/overview.html} (ultima consultazione effettuata in data 2017-12-20);
