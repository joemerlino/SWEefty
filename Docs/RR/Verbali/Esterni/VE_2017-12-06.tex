...
\restoregeometry
	...
	\begin{itemize}
		\item{Deve essere possibile visualizzare il tempo di esecuzione e il momento in cui sono state eseguite le trace;}
		\item{Deve essere possibile visualizzare un identificativo per ogni trace;}
