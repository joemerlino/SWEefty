...
\signature{
    ...
    \includegraphics[width=4cm]{../../CommonImages/firme/freppo.png}
...
\begin{addmargin}[2em]{2em}
  \hspace{1cm} Con la presente lettera il gruppo SWEefty intende comunicarLe ufficialmente che parteciperà alla realizzazione del Progetto di Ingegneria del Software da lei proposto e si impegnerà nella realizzazione del prodotto \emph{Havana} commissionato da IKS S.r.l.\\
