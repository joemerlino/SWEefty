...
\begin{longtable}[h]{|l|p{2.5cm}|p{4.4cm}|p{2.2cm}|l|l|}
	...
	\hline
	RT1 & Inseperienza tecnologica & Le tecnologie adottate sono sconosciute alla maggior parte del gruppo, ciò potrebbe interferire con lo svolgimento delle  attività & Alta & Alta & Intollerabile  \\
	\hline
	RT2 & Problematiche hardware & I computer utilizzati dai membri del gruppo potrebbero guastarsi o subire dei malfunzionamenti impedendo di prosegure con il progetto & Bassa & Media & Tollerabile \\
	\hline
	...
	\hline
	RR1    & Comprensione dei requisiti & Essendo tecncologie completamente nuove la comprensione dei requisiti potrebbe risultare errata o non sufficente. Questo può portare a divergenze tra il nostro operato e le aspettative del fornitore & Media & Media & Moderato \\
	\hline
	RR2    & Modifica dei requisiti & Il settore del software APM è giovane ed in crescente evoluzione, ciò potrebbe portare alla modifica di alucuni requisiti in modo da poter rendere il prodotto software da sviluppare più al passo con i tempi & Bassa & Alta & Moderato \\ 
	\hline
