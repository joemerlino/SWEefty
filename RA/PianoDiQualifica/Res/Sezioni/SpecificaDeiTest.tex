...
Per produrre software di qualità, il gruppo SWEefty definirà dei test per assicurarsi che le unità prodotte funzionino in maniera corretta. Il tracciamento dei test ed il loro esito verrà riportato in questo documento.
    ...
    \begin{longtable}{|c|H|c|}
    	...
    	TS1F1.2&Viene verificato che ogni componente dell'applicazione venga visualizzato in modo differente.& \textcolor{green}{Superato} \\ \hline
    	...
    	TS1F3.4&Viene verificato che al momento del caricamento tutte le sottochiamate di un call tree devono essere visualizzate.& \textcolor{green}{Superato}\\ \hline
    	...
    	TS0V3&Viene verificato che il prodotto sia compatibile con il browser Google Chrome v. 55.x.  & \textcolor{green}{Superato} \\ \hline
    	TS0V4&Viene verificato che il prodotto sia compatibile con il browser Mozilla Firefix v. 50.x. & \textcolor{green}{Superato} \\ \hline
    	TS0V5&Viene verificato che il prodotto sia compatibile con il browser Safari v. 10.x.& \textcolor{green}{Superato} \\ \hline
    	TS0V6&Viene verificato che il prodotto sia compatibile con il browser Internet Explorer v. 11.x.& \textcolor{green}{Superato} \\ \hline
    \end{longtable}
