...
\label{sec:intro}
	...
	\begin{itemize}
		...
		\item \textbf{Visualizzazione della \gl{stack trace}:} vengono visualizzate sotto forma di lista le interazioni fra i componenti e le richieste HTTP effettuate ai \gl{server}. Per ogni \gl{trace} della lista inoltre verrà visualizzata la rispettiva \gl{call tree} e le query effettuate ai \gl{database}.
	\end{itemize}
