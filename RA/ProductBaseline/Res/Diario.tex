...
\begin{table}[H]
	...
	\begin{tabular}{C{2cm}|C{4cm}|C{3cm}|C{3cm}|R{2cm}}
		...
		\hline
		0.3.0 & \emph{Impostato il contenuto di §\ref{sec:Tracciamento}} & Amministratore & Giuseppe Merlino &  2018-04-06 \\
		\hline

		0.2.1 & \emph{Stesura di §\ref{sec:Interazioni}} & Progettista & Giuseppe Merlino &  2018-04-05 \\
		\hline
		0.2.0 & \emph{Impostato il contenuto di §\ref{sec:Interazioni}} & Amministratore & Giuseppe Merlino &  2018-04-04 \\
		\hline
		...
		\hline
		0.1.0 & \emph{Impostato il contenuto di §\ref{sec:Componenti}} & Amministratore & Davide Zago &  2018-04-01 \\
		\hline
