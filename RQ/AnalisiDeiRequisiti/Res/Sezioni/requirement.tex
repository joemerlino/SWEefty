...
\begin{longtable}{|c|H|c|}
	...
	\hypertarget{R1F4.1.4}{R1F4.1.4} & Deve essere possibile visualizzare data e orario del momento in cui è iniziata l' esecuzione di ogni query. & Interno \\ \hline 
	\hypertarget{R1F4.1.5}{R1F4.1.5} & Deve essere possibile visualizzare il tempo di esecuzione di ogni query. & Interno \\ \hline 
	\hypertarget{R1F4.2}{R1F4.2} & Deve essere possibile riordinare la lista delle query relativa ad una singola trace. & Interno \\ \hline 
	\hypertarget{R1F4.2.1}{R1F4.2.1} & Deve essere possibile riordinare la lista delle query di una singola trace in base all'ordine cronologico di esecuzione. & Interno \\ \hline 
	\hypertarget{R1F4.2.1.1}{R1F4.2.1.1} & Deve essere possibile riordinare la lista delle query di una singola trace in base all'ordine cronologico di esecuzione in modo crescente. & Interno \\ \hline 
	\hypertarget{R1F4.2.1.2}{R1F4.2.1.2} & Deve essere possibile riordinare la lista delle query di una singola trace in base all'ordine cronologico di esecuzione in modo decrescente. & Interno \\ \hline 
	\hypertarget{R1F4.2.2}{R1F4.2.2} & Deve essere possibile riordinare la lista delle query di una singola trace in base al tempo di esecuzione. & Interno \\ \hline 
	\hypertarget{R1F4.2.2.1}{R1F4.2.2.1} & Deve essere possibile riordinare la lista delle query di una singola trace in base al tempo di esecuzione in modo crescente. & Interno \\ \hline 
	\hypertarget{R1F4.2.2.2}{R1F4.2.2.2} & Deve essere possibile riordinare la lista delle query di una singola trace in base al tempo di esecuzione in modo decrescente. & Interno \\ \hline 
...
\begin{longtable}{|c|H|c|}
	...
	\hypertarget{R0Q5}{R0Q5} & Il codice sorgente prodotto deve essere rilasciato in un repository pubblico con licenza \gl{open source} che ne permetta l'utilizzo a scopi commerciali. & Capitolato \\ \hline 
...
\begin{longtable}{|c|H|c|}
	...
	\hypertarget{R1V2.1}{R1V2.1} & Il plugin può utilizzare \gl{Node.js}. & Interno \\ \hline 
	\hypertarget{R1V2.2}{R1V2.2} & Il plugin può utilizzare il \gl{framework} \gl{AngularJS}. & VE\_2017-12-19 \\ \hline 
	\hypertarget{R1V2.3}{R1V2.3} & Il plugin può utilizzare la libreria \gl{D3.js}. & Capitolato \\ \hline 
	\hypertarget{R1V2.4}{R1V2.4} & Il plugin può utilizzare la libreria Canvas.js. & Capitolato \\ \hline 
	\hypertarget{R1V2.5}{R1V2.5} & Il plugin può utilizzare la libreria \gl{Chart.js}. & Capitolato \\ \hline 
	\hypertarget{R1V2.6}{R1V2.6} & Il plugin può utilizzare la libreria Plottly.js. & Capitolato \\ \hline 
	\hypertarget{R1V2.7}{R1V2.7} & Il plugin può utilizzare la libreria \gl{Cytoscape.js}. & Capitolato \\ \hline 
