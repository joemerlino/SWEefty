...
*/
	...
	\begin{itemize}
		\item \textbf{REST client}: Permette di eseguire chiamate REST all'interno dell'ambiente \emph{Atom}, velocizzando il processo di \emph{testing} di esse per uno sviluppatore; 
