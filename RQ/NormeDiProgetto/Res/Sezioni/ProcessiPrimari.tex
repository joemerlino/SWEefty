...
*/
	...
	\label{sec:plugins}
	\Spazio
	Per sviluppare il prodotto il gruppo si avvarrà di una serie di plugin integrati nell'IDE. Essi sono stati selezionati appositamente per facilitare la produzione del \emph{prodotto}. Essi sono:
	...
	\begin{itemize}
		...
		\item \textbf{json-converter}: permette di convertire dati presentati in vari formati in json, ovvero il formato utilizzato da Javascript per la rappresentazione degli stessi. 
