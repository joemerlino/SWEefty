...
\label{sec:intro}
	...
	Questo documento ha lo scopo di semplificare l'apprendimento delle funzionalità offerte dal plugin \emph{Havana}, \gl{prodotto} sviluppato dal gruppo SWEefty.
