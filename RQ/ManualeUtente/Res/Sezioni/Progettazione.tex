...
Se vengono riscontrati errori o problematiche di vario genere si prega di segnalare l'avvenuto all'indirizzo e-mail sweeftyteam@gmail.com specificando la tipologia della problematica oppure di aprire una segnalazione nell'apposita sezione \gl{\emph{Issues}} della \gl{repository} \gl{GitHub} associata al prodotto Havana.
