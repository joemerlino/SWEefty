...
\section*{\centering{Diario delle modifiche}}
	\begin{longtable}[H]{C{2cm}|C{4cm}|C{3cm}|C{3cm}|R{2cm}}
		...
		3.3.0 &\emph{Verifica del Documento} & Verificatore & Elia Montecchio & 2018-04-13 \\
		\hline
		
		3.2.0 &\emph{Scrittura sezione \ref{sec:ConsuntivoCodifica}} & Project Manager & Zago Davide & 2018-04-13 \\
		\hline
