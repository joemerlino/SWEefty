...
\section*{\centering{Diario delle modifiche}}
	\begin{longtable}[H]{C{2cm}|C{4cm}|C{3cm}|C{3cm}|R{2cm}}
		...
		4.0.0 &\emph{Approvazione del Documento} & Project Manager & Zago Davide & 2018-04-14 \\
		\hline
		
		3.5.0 &\emph{Verifica del Documento} & Verificatore & Elia Montecchio & 2018-04-13 \\
		\hline
		
		3.4.0 &\emph{Scrittura sezione \ref{sec:CodificaRischi}} & Project Manager & Zago Davide & 2018-04-13 \\
		\hline
		
		3.3.0 &\emph{Scrittura sezione \ref{sec:ConsuntivoCodifica}} & Project Manager & Zago Davide & 2018-04-13 \\
		\hline
