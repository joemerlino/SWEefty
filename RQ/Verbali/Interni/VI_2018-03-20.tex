...
\newcommand{\Titolo}{Verbale riunione 20 Marzo 2018}
...
\restoregeometry
    ...
    \begin{itemize}
   	...
   	\item Riguardo alla lacune evidenziate nel documento \emph{PianoDiProgetto v2.0.0} si è deciso \textbf{ 01/VI\_2018-03-20 } di rivedere nell'immediato l'incongruenza delle ore rendicontate, sanandola per poi riconsegnare il documento;
    	...
    	\item  \textbf{ 04/VI\_2018-03-20 } Lisa Parma e Davide Zago si occupano di stilare il documento \emph{Manuale Sviluppatore}, in seguito si occuperanno di sviluppare il backend del plugin;
