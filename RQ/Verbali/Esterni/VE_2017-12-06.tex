...
\restoregeometry
	...
	\section{Informazioni generali}
		\subsection{Informazioni incontro}
			% - INSERT INFORMAZIONI INCONTRO
			\begin{itemize}
				\item { \textbf{Luogo:} Azienda IKS S.r.l.  }
	...
	\begin{itemize}
		\item{ \textbf{ 01/VE\_2017-12-06 }  Deve essere possibile visualizzare il tempo di esecuzione, il momento in cui sono state eseguite le trace e lo status code con un eventuale messaggio di errore nel caso la richiesta HTTP fallisse;}
		\item{ \textbf{ 02/VE\_2017-12-06 } Deve essere possibile visualizzare un identificativo per ogni trace corrispondente alla richiesta HTTP;}
		\item{ \textbf{ 03/VE\_2017-12-06 } Deve essere possibile visualizzare il call tree relativo ad una determinata trace;}
		\item{ \textbf{ 04/VE\_2017-12-06 } In questo call tree deve essere possibile visualizzare il nome di ogni metodo presente, indentato in base alla sua "profondità";}
		\item{ \textbf{ 05/VE\_2017-12-06 } Deve essere possibile interagire con il call tree per agevolarne la comprensibilità;}
